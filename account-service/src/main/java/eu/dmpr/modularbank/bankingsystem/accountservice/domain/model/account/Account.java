...
import eu.dmpr.modularbank.bankingsystem.accountservice.domain.model.Aggregate;
...
public class Account extends Aggregate {
  ...
  public void deposit(BigDecimal amount) {
    ...
    AccountDepositedEvent accountDepositedEvent = new AccountDepositedEvent(getId(), now(UTC), getNextVersion(), amount, newBalance);
